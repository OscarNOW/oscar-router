...
export async function transformNodeRequest(nodeReq) {
    ...
    const parsedUrl = URL.parse(reqUrl, 'http://localhost');
    if (!parsedUrl) {
...
export function sendNodeResponse(nodeReq, nodeRes, response) {
    let headers = Object.create(null);
